...
describe('ResultDataFactory', () => {
    ...
    describe('fetchGetCombinedResultsSummary', () => {
        ...
        test('should throw error when no test data found', async () => {
            ...
            expect(logger.error).toHaveBeenCalledWith(expect.stringContaining('Error occurred while trying the fetch Test Group Result Summary Data'));
        });
    ...
    describe('fetchTestReporterResults', () => {
        test('should fetch and adapt test reporter results', async () => {
            ...
            await factory.fetchTestReporterResults(selectedFields, true);
        ...
        test('should throw error when no test data found', async () => {
            ...
            await factory.fetchTestReporterResults([], false);
    ...
    describe('jsonSkinDataAdapter', () => {
        ...
        test('should handle test-result-test-group-summary-table adapter', async () => {
            const result = await factory.jsonSkinDataAdapter('test-result-test-group-summary-table', [{ raw: 'data' }]);
        ...
        test('should handle errors', async () => {
            ...
            await expect(factory.jsonSkinDataAdapter('test-result-test-group-summary-table', []))
                .rejects.toThrow('Adapter error');

            expect(logger.error).toHaveBeenCalledWith(expect.stringContaining('Error occurred during build json Skin data adapter'));
        });
    });
    ...
    describe('edge cases and advanced scenarios', () => {
        ...
        test('should handle complex nested data structures', async () => {
            ...
            jest.spyOn(factory, 'jsonSkinDataAdapter')
                .mockImplementationOnce(async () => complexNestedData);
        ...
        test('should handle empty field arrays with different filter settings', async () => {
            ...
            await factory.fetchTestReporterResults([], true);
            expect(mockResultDataProvider.getTestReporterResults).toHaveBeenCalledWith(
                expect.any(String),
                expect.any(String),
                expect.any(Array),
        ...
        test('calling methods in sequence should work as expected', async () => {
            ...
            await factory.fetchTestReporterResults(['field1'], true);
